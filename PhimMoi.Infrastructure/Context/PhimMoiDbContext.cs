...
namespace PhimMoi.Infrastructure.Context
{
    public class PhimMoiDbContext : IdentityDbContext<User>
    {
        public PhimMoiDbContext(DbContextOptions<PhimMoiDbContext> options) : base(options) { }
