...
using PhimMoi.Infrastructure.Repositories;

namespace PhimMoi.Infrastructure.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        private readonly PhimMoiDbContext _context;

        public UnitOfWork(PhimMoiDbContext context)
        {
            _context = context;
        }
