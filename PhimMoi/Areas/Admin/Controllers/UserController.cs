...
using PhimMoi.Areas.Admin.Models;
...
namespace PhimMoi.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(IMapper mapper, IUserService userService, IRoleService roleService, IWebHostEnvironment environment)
        {
            _mapper = mapper;
